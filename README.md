...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **83.3B tokens across 123 days**, on 24 models from 9 labs, 93% of it served
> from cache. About 49% was spent by subagents rather than by me
...
| **Fan-out** | 49% of recent tokens are spent by subagents. Much of the work is delegated by other agents, not by me. |
