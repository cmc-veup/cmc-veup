...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **90.7B tokens** over 129 active days · 24 models · 9 labs · 90% cache reads · 48% spent by subagents.
...
| **Provider diversity** | 24 models, 9 labs — though one carries 84% of spend. |
