...
**[viberank](https://www.viberank.app)** is a public leaderboard where developers submit their
AI coding usage — around a thousand people, ranked by spend. My entry is the same data as the
badges above, submitted by the same tool rather than regenerated by the leaderboard's own
collector, which would have discarded the corrections:
**[viberank.app/profile/cmc-veup](https://viberank.app/profile/cmc-veup)** — currently **#11**.
