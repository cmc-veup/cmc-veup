...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **97.6B tokens** over 136 active days · 25 models · 9 labs · 90% cache reads · 48% spent by subagents.
...
| **Fan-out** | 48% of recent tokens spent by subagents; 35% across the months whose transcripts survived. |
