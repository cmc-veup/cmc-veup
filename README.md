...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **97.3B tokens** over 135 active days · 25 models · 9 labs · 90% cache reads · 45% spent by subagents.
...
| **Fan-out** | 45% of recent tokens spent by subagents; 38% across the months whose transcripts survived. |
