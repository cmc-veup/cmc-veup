...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **85.4B tokens** over 123 active days · 24 models · 9 labs · 89% cache reads · 47% spent by subagents.
...
| | |
|---|---|
| **Scale** | 0 → 620 agents, elastic · typical wave 170–505 · 123 concurrent at peak |
