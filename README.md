...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **95.9B tokens** over 134 active days · 25 models · 9 labs · 90% cache reads · 45% spent by subagents.
...
| **Fan-out** | 45% of recent tokens spent by subagents; 37% across the months whose transcripts survived. |
| **Provider diversity** | 25 models, 9 labs — though one carries 83% of spend. |
