...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **85.4B tokens** over 123 active days · 24 models · 9 labs · 89% cache reads · 46% spent by subagents.
...
| | |
|---|---|
| **Scale** | 0 → 906 agents, elastic · typical wave 196–732 · 163 concurrent at peak |
