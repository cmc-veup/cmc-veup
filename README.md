...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **91.3B tokens** over 129 active days · 25 models · 9 labs · 90% cache reads · 49% spent by subagents.
...
| **Fan-out** | 49% of recent tokens spent by subagents; 38% across the months whose transcripts survived. |
