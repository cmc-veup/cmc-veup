...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **94.0B tokens** over 131 active days · 25 models · 9 labs · 90% cache reads · 46% spent by subagents.
...
| **Fan-out** | 46% of recent tokens spent by subagents; 38% across the months whose transcripts survived. |
