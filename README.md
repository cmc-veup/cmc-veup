...
<!-- BEGIN LIVE-SUMMARY -->
> [!NOTE]
> **92.4B tokens** over 129 active days · 25 models · 9 labs · 90% cache reads · 48% spent by subagents.
...
| **Fan-out** | 48% of recent tokens spent by subagents; 38% across the months whose transcripts survived. |
